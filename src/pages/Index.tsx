...
const featuredPosts = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1581089778245-3ce67677f718?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70',
    category: 'Tecnologia',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70',
    category: 'SEO',
...
const categories = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70'
  },
  {
    id: '2',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1432888498266-38ffec3eaf0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70'
  },
  {
    id: '3',
    name: 'SEO',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1649101067474-b436b68eda4a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70'
  },
  {
    id: '4',
    name: 'Redes Sociais',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70'
  }
];
...
const latestArticles = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70',
    category: 'Analytics',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1589254065878-42c9da997008?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=70',
    category: 'Tecnologia',
...
const Index = () => {
  ...
  useEffect(() => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            } else if (entry.target === latestArticlesRef.current) {
    ...
    if (latestArticlesRef.current) observer.observe(latestArticlesRef.current);
    if (newsletterRef.current) observer.observe(newsletterRef.current);
    
    return () => {
      if (featuredSectionRef.current) observer.unobserve(featuredSectionRef.current);
      if (latestArticlesRef.current) observer.unobserve(latestArticlesRef.current);
  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ref={newsletterRef}
        className={`py-16 md:py-20 bg-conecte-600 dark:bg-conecte-800 text-white transition-all duration-700 transform ${
